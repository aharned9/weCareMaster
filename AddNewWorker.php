...
$UserQuery = "SELECT First_Name, Last_Name FROM wecare.employee";
...
?></center>
			...
			<p>
			<label for="name" style="float:left;">Employee Name</label>
			<input type = "text" id = "myText" size="16" style="float:right;clear:right"
                 
			</p>
			&nbsp;
			<p>
			<label for="dob" style="float:left;clear:left">Employee Birthday</label>
			<input type = "dob" id = "childBirth" size="16" style="float:right;clear:right"
                  
			</p>
			&nbsp;
			<p>
			<label for="allergies" style="float:left;">Employee Number</label>
			<input type = "allergic" id = "childAllergy" size="16" style="float:right;clear:right"
                 
			</p>
			&nbsp;
			<p>
			<label for="ParentName" style="float:left;clear:left">Phone Number</label>
			<input type = "ParentName" id = "childParent" size="16" style="float:right;clear:right"
                  
			</p>
			&nbsp;
			<p>
			<label for="ParentContact" style="float:left;clear:left">Email</label>
			<input type = "ParentEmail" id = "childParentEmail" size="16" style="float:right;clear:right"
                  
			</p>
			&nbsp;
			<p>
			<label for="ParentNum" style="float:left;clear:left">Assigned Class</label>
